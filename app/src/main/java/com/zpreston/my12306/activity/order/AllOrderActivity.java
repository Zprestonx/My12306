...
public class AllOrderActivity extends AppCompatActivity {
    ...
    private List<Map<String, Object>> getData() {//实现Map的数据构造
        ...
        List<Order> list = orderDao.queryAllOrders("775079852@qq.com");//查询已支付订单
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final optactAdapter opt = new optactAdapter(getData(), AllOrderActivity.this);
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                builder.setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(which==0) {
                            Log.e("Tag-contactId",String.valueOf((int)mData.get(position).get("contactId")));
                            Log.e("Tag-contactId",orderNo);
                            orderDao.returnTicket("775079852@qq.com",orderNo,(int)mData.get(position).get("contactId"));

                            mData=getData();
                            opt.setmData(getData());
                            Log.e("beforeMessage",String.valueOf(mData.size()));
